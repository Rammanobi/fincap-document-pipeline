...
def run_phase1(file_path: str) -> tuple[DocumentText, str]:
    """
    ...
    output_file = os.path.join(settings.output_dir, "page_text.txt")
...
def run_phase3(extraction: dict, document_id: str) -> dict:
    """
    ...
    output_file = os.path.join(settings.output_dir, "assignment.json")
    with open(output_file, "w", encoding="utf-8") as f:
